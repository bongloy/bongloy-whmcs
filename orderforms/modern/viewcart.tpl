...
<div id="order-modern">
    ...
    {if $cartitems!=0}
        ...
        <form method="post" action="{$smarty.server.PHP_SELF}?a=checkout" id="mainfrm">
            ...
            <div align="center">
                <button type="submit" id="btnCompleteOrder"{if $cartitems==0} disabled{/if} onclick="this.value='{$LANG.pleasewait}'" class="btn btn-primary btn-lg submitbutton ordernow" {if $custtype eq "existing" && !$loggedin}formnovalidate{/if}>
                    {$LANG.checkout}
